...
namespace App.Infrastructure.DataAccess.Repository
{
    public class AdminRepository : IAdminRepository
    {
        ...
        public async Task<MyAdmin> Add(MyAdmin inputAddress, CancellationToken cancellation)
        {
        ...
        {
            var address = _db.MyAdmins.FirstOrDefault(x => x.Id == Id && x.IsDeleted == false);
