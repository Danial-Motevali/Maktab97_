...
namespace UI
{
    public class DataSeeder
    {
        public static void Seedfordata(ApplicationDbContext dbContext) 
        {
            ...
            //    {
            //        new User {FirstName = "Danial", LastName = "Motevali", UserName = "Danial",NormalizedUserName ="DANIAL", Email = "danial.motevali.82@gmail.com", IsDeleted = false, PasswordHash = "AQAAAAIAAYagAAAAEJgL3NT21uZb72NE7HpS3Y4Tk1QN3OnrzidYKp53nxeHw/ThvSSV+5rUygVnuFMQJw==", SecurityStamp = null},
            //        new User { FirstName = "First", LastName = "Admin", UserName = "Admin1", NormalizedUserName = "ADMIN1", Email = "admin1@gmail.com", IsDeleted = false, PasswordHash = "AQAAAAIAAYagAAAAEJgL3NT21uZb72NE7HpS3Y4Tk1QN3OnrzidYKp53nxeHw/ThvSSV+5rUygVnuFMQJw==", SecurityStamp = null},
            //        new User { FirstName = "First", LastName = "Buyer", UserName = "Buyer1", NormalizedUserName = "BUYER1", Email = "buyer1@gmail.com", IsDeleted = false, PasswordHash = "AQAAAAIAAYagAAAAEJgL3NT21uZb72NE7HpS3Y4Tk1QN3OnrzidYKp53nxeHw/ThvSSV+5rUygVnuFMQJw==", SecurityStamp = null},
            //        new User { FirstName = "First", LastName = "Seller", UserName = "Seller1", NormalizedUserName = "SELLER1", Email = "seller1@gmail.com", IsDeleted = false, PasswordHash = "AQAAAAIAAYagAAAAEJgL3NT21uZb72NE7HpS3Y4Tk1QN3OnrzidYKp53nxeHw/ThvSSV+5rUygVnuFMQJw==", SecurityStamp = null}
            //    };
